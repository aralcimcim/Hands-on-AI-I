...
def check_module_versions() -> None:
    ...
    sklearn_check = '(\u2713)' if Version(sklearn.__version__) >= Version(r'1.2') else '(\u2717)'
    ...
    scipy_check = '(\u2713)' if Version(scipy.__version__) >= Version(r'1.5.0') else '(\u2717)'
    spacy_check = '(\u2713)' if Version(spacy.__version__) >= Version(r'2.3.0') else '(\u2717)'
...
def plot_word_embeddings_2d(data: pd.DataFrame, words: list = None, figsize: tuple = (10, 10),
                            hide_ticks: bool = True) -> None:
    """
...
def plot_word_embeddings_3d(data: pd.DataFrame, words: list = None, figsize: tuple = (10, 10),
                            hide_ticks: bool = True) -> None:
    """
